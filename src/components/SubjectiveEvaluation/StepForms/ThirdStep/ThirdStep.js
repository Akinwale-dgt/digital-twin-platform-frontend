  ...
  return (
    <React.Fragment>
      <Box container spacing={3} className={styles.main}>
        <Typography variant='p' sx={{textAlign: 'center'}}>For the condition you just completed, please rate the level of exertion you experienced during the task using the scale below
        </Typography>
        ...
        <fieldset style={{marginLeft: "68px"}} className={styles.fieldsetStyle}>
            <legend>Choose your rating</legend>
            <Box>
            <Typography variant={'p'} id="my-radio-group">Exertion Rating</Typography>
            <Box role="group" aria-labelledby="my-radio-group" className={styles.formField}>
              <label>
                <Field type="radio" name="exertion" value="6" />
               6
              </label>
              <label>
                <Field type="radio" name="exertion" value="7" />
                7
              </label>
              <label>
                <Field type="radio" name="exertion" value="8" />
                8
              </label>
              <label>
                <Field type="radio" name="exertion" value="9" />
                9
              </label>
              <label>
